...
9. Протестировала сервер локально
```bash
mkdocs serve
```
10. Собрала структуру сайта с помощью build
```bash
...
---
[Вернуться на главную](https://github.com/Anne4ka-rom/anne4ka-rom.github.io/blob/main/index)